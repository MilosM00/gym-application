...
<body>  
    ...
    <?php
        ...
        $code = $connection->prepare("insert into Customer(CustomerFirstName, CustomerLastName, CustomerEmail, CustomerPhone, CustomerPack) values(?, ?, ?, ?, ?)");
    ...
    <div class="container-register-success">
        ...
        <p>
            Thank you for your time! <br /> We will call you as soon as possible!
        </p>
        <div>
